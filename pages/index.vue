        ...
        <b-row>
            <b-col cols="12" lg="6">
                <div class="p-3">
                    <b-col>
                        <b-row>
                            <b-img src="~/assets/images/lared_logo.png" fluid alt="LaRed" width="240" />
                        </b-row>
                        <b-row>
                            <div>
...
export default {
    ...
    computed: {
        ...
        amountPlaceholder() {
            return `(Faucet will pay up to ${this.networkInfo.nativeCurrencyMaxOut} of selected token, or enter a custom amount.)`;
        },
        faucetAccountUrl() {
